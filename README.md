...
{
  "name": "Meu Contador Digital",
  "short_name": "ContadorDigital",
  "description": "Aplicativo educativo para organizar finanças. Funciona offline!",
...
const CACHE_NAME = "contador-digital-pwa-v2";
const urlsToCache = [
  "index.html",
  "manifest.json",
  "icon-192.png",
...
// Servindo arquivos do cache - permite funcionamento offline
